...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>NoukeQalam News - Sach Har Waqt, Har Haal </title>
...
?>
                            ...
                            <div class="single-recent mb-100">
                                ...
                                <div class="what-cap">
                                   <a href="category.php?catid=<?php echo htmlentities($row['cid'])?>"><span class="color1"><?php echo htmlentities($row['category']);?></span></a>
                                    <h4><a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>"><?php echo htmlentities($row['posttitle']);?></a></h4>
                                </div>
                            </div>
                        ...
                        <div class="weekly2-news-active dot-style d-flex dot-style">
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <iframe  src="https://www.youtube.com/embed/53Z7e0C1NMI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

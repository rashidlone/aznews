  <div class="col-md-4">
          ...
          <!-- Search Widget -->
          <div class="card mb-4">
            <h5 class="nastaliq card-header">تلاش کریں</h5>
            <div class="card-body">
                   <form name="search" action="search.php" method="post">
              <div class="input-group">
           
        <input type="text" name="searchtitle" class="form-control" placeholder="...تلاش کیجیے" required>
